...
class ConvDecoder(Module):
    def __init__(self, data_len: int, n_latent: int, n_deconv_blocks=3, in_channels=128, n_fc=2048, var=0.05):
        ...
        for i in range(n_deconv_blocks):
            ...
            de_conv_head.append(ConvTranspose2d(in_channels, out_channels, kernel_size=3, stride=2, padding=1, output_padding=out_padding))
        ...
        self.mu = torch.nn.Linear(data_len, data_len)
